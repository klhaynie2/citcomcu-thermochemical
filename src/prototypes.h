...
void get_mesh_from_file(struct All_variables *E, float *XX[4]); /* MIB JAN07 */
/* Output.c */
...
void get_volume_velo(struct All_variables *E, float *SV); /* MIB JAN07 */
void output_temp_binary(struct All_variables *E, int file_number); /* MIB JAN07 */
void get_visc_pres(struct All_variables *E, float *visc, float *pres, float *edot, float *vtyp); /* MIB JAN07 */
void get_tracersX(struct All_variables *E, float *TX); /* KLH 4Nov2018*/
void get_tracersY(struct All_variables *E, float *TY); /* KLH 4Nov2018*/
void get_tracersZ(struct All_variables *E, float *TZ); /* KLH 4Nov2018*/
void get_tracersC(struct All_variables *E, float *TC); /* KLH 4Nov2018*/
...
int read_new_field(struct All_variables *E, float *field, char *name); /* MIB JAN07 */
...
void weak_regions(struct All_variables *E, float *EEta);   /* MIB JAN07 */
void get_weak_regions(struct All_variables *E); /* MIB, JAN07 */
void composite_viscosity(struct All_variables *E, float *Eta, float *EEta);   /* MIB JAN07 */
