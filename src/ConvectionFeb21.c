...
/* ==================================================================================
 Changes to convection_initial_markers were made to read in an initial composition
 field and assign tracers an initial value of 0 (ambient) or 1 (anomalous) based
 on the input composition field. The original method of assigning tracers a value of
